...
import com.gustavohenning.ProductService.entity.Product;
import com.gustavohenning.ProductService.exception.ProductServiceCustomException;
...
import com.gustavohenning.ProductService.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public long addProduct(ProductRequest productRequest) {
        ...
        log.info("Product Crated!");
        return product.getProductId();
    }

    @Override
    public ProductResponse getProductById(long productId) {
        log.info("Get the product productId: {}", productId);
