package com.gustavohenning.OrderService.controller;

import com.gustavohenning.OrderService.OrderServiceConfig;
...
import com.gustavohenning.OrderService.service.OrderService;
...
public class OrderControllerTest {
    ...
    @Test
    public void test_WhenPlaceOrderWithWrongAccess_thenThrow500() throws Exception {
        OrderRequest orderRequest = getMockOrderRequest();
        MvcResult mvcResult
                = mockMvc.perform(MockMvcRequestBuilders.post("/order/placeOrder")
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
